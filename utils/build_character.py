...
# filters allow only desired fields to be assigned
ALLOWED_RACE_FIELDS = {
...
def build_character(player_name, character_name, race_name, class_name, background_name):
    ...
    # filter out unwanted data as it is pulled in
    ...
    return Character(
        ...
        # return race, class, and background objects with desired attributes added
